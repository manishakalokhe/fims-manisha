...
import { PahuvaidhakiyaTapasaniForm } from './JilhastariyaTapasaniSuchiForm.tsx';
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-4 md:p-6">
      <div className="max-w-4xl mx-auto">
       ...
       { key: 'Jilhastariya_Tapasani_Suchi_Form', title: 'जिल्हास्तरीय तपासणी सूची', subtitle: 'Jilhastariya Tapasani Suchi Form', color: 'red', active: true },
