...
export const FIMSNewInspection: React.FC<FIMSNewInspectionProps> = ({
  ...
  const renderInspectionForm = () => {
    ...
    if (selectedInspectionType === 'jilhastariya inspection form') {
      return (
...
{  key: 'jilhastariya_inspection_form',  title: 'जिल्हास्तरीय अधिकारी तपासणी', 
      subtitle: 'Jilhastrariya Inspection Form',  color: 'purple' 
    },
         ...
         //   { key: 'form_15', title: 'Form 15 Title', subtitle: 'Form 15 Description', color: 'rose' }
            ...
            >
             ...
             ) : form.key === 'jilhastariya_inspection_form' ? (
                  <>
