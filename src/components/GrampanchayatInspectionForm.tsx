...
const Table14VaVitt = () => (
  <div style={{ maxWidth: "1000px", margin: "0 auto" }}>
    <div style={{ fontWeight: "bold", marginBottom: "8px" }}>
      (14) 14 वा वित्त आयोगामधून हाती घेतलेली कामे व त्याची प्रगती .
    </div>
    <table
      style={{
        width: "100%",
    ...
    >
      <thead>
        <tr>
          <th style={{ width: "40px", padding: "4px" }}>अ. क्र.</th>
          <th style={{ width: "140px", padding: "4px" }}>योजनेचे नाव</th>
          <th style={{ width: "170px", padding: "4px" }}>कामाचा प्रकार</th>
          <th style={{ width: "100px", padding: "4px" }}>अंदाजित रक्कम</th>
          <th style={{ width: "100px", padding: "4px" }}>मिळालेले अनुदान</th>
          <th style={{ width: "100px", padding: "4px" }}>झालेला खर्च</th>
        </tr>
      </thead>
      <tbody>
        <tr>
          <td style={{ padding: "4px", textAlign: "center" }}>1</td>
          <td style={{ padding: "4px" }}>14 वा वित्त आयोग</td>
          <td style={{ padding: "4px" }}>एल.ई.डी.लाईट खरेदी</td>
          <td />
          <td />
          <td />
        </tr>
        <tr>
          ...
          <td />
          <td style={{ padding: "4px" }}>कचरा कुंडी</td>
          <td />
          <td />
          <td />
        </tr>
        <tr>
          ...
          <td />
          <td style={{ padding: "4px" }}>फर्निचर</td>
          <td />
          <td />
          <td />
        </tr>
        <tr>
          ...
          <td />
          <td style={{ padding: "4px" }}>टि.व्ही.संच खरेदी</td>
          <td />
          <td />
          <td />
        </tr>
        <tr>
          ...
          <td />
          <td style={{ padding: "4px" }}>आपले सरकार सेवा केंद्र खर्च</td>
          <td />
          <td />
          <td />
        </tr>
        <tr>
          <td style={{ padding: "4px", textAlign: "center" }}>6</td>
          <td />
          <td style={{ padding: "4px" }}>वाटर मीटर</td>
          <td />
          <td />
          <td />
        </tr>
        <tr>
          <td style={{ padding: "4px", textAlign: "center" }}>7</td>
          <td />
          <td style={{ padding: "4px" }}>सि.सी.रोड</td>
          <td />
          <td />
          <td />
        </tr>
        <tr>
          <td style={{ padding: "4px", textAlign: "center" }}>8</td>
          <td />
          <td style={{ padding: "4px" }}>आपले सरकार सेवा केंद्र खर्च</td>
          <td />
          <td />
        ...
        <tr>
          <td style={{ padding: "4px", textAlign: "center" }}>9</td>
          <td />
          <td style={{ padding: "4px" }}>फॉगिंग मशीन</td>
          <td />
          <td />
          <td />
        </tr>
        <tr>
          <td style={{ padding: "4px", textAlign: "center" }}>10</td>
          <td />
          <td style={{ padding: "4px" }}>ग्रां.प.भवन</td>
          <td />
          <td />
          <td />
        </tr>
        <tr>
          <td style={{ padding: "4px", textAlign: "center" }}>11</td>
          <td />
          <td style={{ padding: "4px" }}>संगणक</td>
          <td />
          <td />
          <td />
        </tr>
